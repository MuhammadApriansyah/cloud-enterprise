...
export default function Architecture() {
  ...
  return (
    <section id="architecture-section" className="w-full max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center py-24 relative z-10">
      {/* PERBAIKAN: Penambahan id="architecture-section" dan max-w-6xl px-6 */}
      <motion.div
      ...
      {/* PERBAIKAN: Scroll Reveal pada Radar */}
      <motion.div
