...
export default function Services() {
  return (
    <div className="w-full mx-auto space-y-16 py-10">
      ...
      {/* FR-01 & FR-02: Bento Box Grid Architecture */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[240px]">
        
        {/* Bento 1: Feature Highlight (Large) */}
        <InteractiveSurface className="md:col-span-8 p-10 flex flex-col justify-between group">
        ...
        <InteractiveSurface className="md:col-span-4 p-8 flex flex-col justify-center items-center text-center group">
        ...
        <InteractiveSurface className="md:col-span-5 p-8 flex flex-col justify-between group">
        ...
        <InteractiveSurface className="md:col-span-7 p-8 flex flex-col justify-between group overflow-hidden">
